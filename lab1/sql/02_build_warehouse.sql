...
insert into dim_product (name, price, quantity, brand, weight, color, size, material, description, rating, reviews_count, released_on, expires_on, category_id)
select
    p.product_name,
...
insert into fact_sales (sale_date, quantity, total_price, customer_id, seller_id, product_id, store_id, supplier_id)
select
